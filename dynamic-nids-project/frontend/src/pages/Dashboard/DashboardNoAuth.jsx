// frontend/src/pages/Dashboard/DashboardNoAuth.jsx - Version without authentication
    ...
    <div className="dashboard">
      <header className="dashboard-header">
        <div className="header-left">
          <h1>NIDS Dashboard (Demo Mode)</h1>
          <div className="stats">
        ...
        <div className="header-right">
          <span className="demo-badge">Demo Mode - No Auth Required</span>
        </div>
      </header>
